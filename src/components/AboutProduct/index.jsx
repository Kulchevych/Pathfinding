      ...
      <div className={classes.container}>
        ...
        {activeTab === 'Про програму' && (
          <div className={classes.text}>
            ...
            початку до кожної вершини. Містить такі функції: 
            <ul className={classes.list}>
        ...
        {activeTab === 'Інструкція' && (
          ...
          <ul>
              <li>Потрібно мати текстовий файл, в кожен окремий рядок повинен містити інформацію про ребро мережі, а саме - з якої вершини виходить та входить ребро й "вага" цього ребра. Усі дані вводяться послідовно через пробіл. 
                <div>
                  Приклад:
                  <ul>
                    <div>
              ...
              <li>Натиснути кнопку "Завантажити файл" і обрати його файлу txt формату</li>
